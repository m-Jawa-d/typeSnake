...
const LIGHT_THEMES = [
  ...
  { id: 'ivory',  label: 'ivory',  bg: '#faf7f2', main: '#9b7d4a', text: '#3a3228', sub: '#c4b89a' },
  { id: 'zinc',   label: 'zinc',   bg: '#f4f4f5', main: '#3f3f46', text: '#18181b', sub: '#a1a1aa' },
  { id: 'rose',   label: 'rose',   bg: '#fff5f5', main: '#e11d48', text: '#1c0a0a', sub: '#fca5a5' },
  { id: 'sky',    label: 'sky',    bg: '#f0f7ff', main: '#0369a1', text: '#0c1a2e', sub: '#93c5fd' },
];

const DARK_THEMES = [
  { id: 'carbon',   label: 'carbon',   bg: '#111111', main: '#e2b714', text: '#d1d0c5', sub: '#646669' },
  { id: 'mocha',    label: 'mocha',    bg: '#1e1e2e', main: '#cba6f7', text: '#cdd6f4', sub: '#585b70' },
  { id: 'forest',   label: 'forest',   bg: '#1a2318', main: '#a3be8c', text: '#d8e4d0', sub: '#4a5e44' },
  { id: 'slate',    label: 'slate',    bg: '#0f172a', main: '#38bdf8', text: '#cbd5e1', sub: '#334155' },
  { id: 'graphite', label: 'graphite', bg: '#1c1c1e', main: '#ff9f0a', text: '#e5e5ea', sub: '#48484a' },
];
...
export default function Settings({ isOpen, onClose }) {
  const { theme, setTheme, language, setLanguage, mood, setMood } = useGameStore();
